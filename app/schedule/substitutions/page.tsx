        ...
        return (
            <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50/50">
                <Card className="max-w-md w-full border-0 shadow-2xl text-center p-8 space-y-4">
                    ...
                    <p className="text-slate-600">Only moderators and admins can enter substitutions.</p>
        ...
        <div className="min-h-screen bg-slate-50/50 py-12 px-4">
            <div className="max-w-3xl mx-auto space-y-8">
                <div className="text-center space-y-2">
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900">Enter a Substitution</h1>
